...
<body>
    ...
    <div class="main-content">
        <div class="header">
            ...
            <div class="user-info">
                <img src="https://ui-avatars.com/api/?name=<?php echo urlencode($user['full_name']); ?>&background=4a90e2&color=fff" alt="User">
        ...
        <div class="stats-container">
            <div class="stat-card">
                ...
                <div class="stat-card-value"><?php echo count($current_borrowings); ?></div>
                <div class="stat-card-title">Books Borrowed</div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-card-value">
                    <?php 
                        $due_soon = array_filter($current_borrowings, function($b) {
                            return $b['days_remaining'] <= 3 && $b['days_remaining'] > 0;
                        });
                        echo count($due_soon);
                    ?>
                </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-card-value">
                    <?php 
                        $overdue = array_filter($current_borrowings, function($b) {
            ...
            <div class="stat-card">
                ...
                <div class="stat-card-value"><?php echo count($borrowing_history); ?></div>
                <div class="stat-card-title">Reading History</div>
            </div>
        </div>
                            ...
                            <?php foreach ($current_borrowings as $borrowing): ?>
                                <tr class="<?php echo $borrowing['days_remaining'] <= 3 && $borrowing['days_remaining'] > 0 ? 'due-soon' : ''; ?>
                                    ...
                                    <td class="action-buttons">
                                        <a href="user_dashboard.php?return=<?php echo $borrowing['borrowing_id']; ?>" class="btn btn-success btn-sm">
                                            <i class="fas fa-undo"></i> Return
                                        </a>
                                        <a href="user_dashboard.php?renew=<?php echo $borrowing['borrowing_id']; ?>" class="btn btn-warning btn-sm">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Recent Reading History</h3>
            </div>
